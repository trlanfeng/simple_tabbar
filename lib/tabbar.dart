...
class EasyTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// and the entire [EasyTabBar] is scrollable. Otherwise each tab gets an equal
  ...
  /// An optional callback that's called when the [EasyTabBar] is tapped.
  ///
  ...
  @override
  _EasyTabBarState createState() => _EasyTabBarState();
}
